jQuery(document).ready(function( $ ) {
  ...
  function openWhatsApp() {
	if(isMobile()) {
	  window.open('whatsapp://send?phone=919073313918');
	} else {
	  window.open('https://wa.me/919073313918', '_blank');
	}
  };
  ...
  // open whatsapp
  // $('#contact .contact-whatsapp a').on('click', openWhatsApp);
  // $('.social-icons .whatsapp').on('click', openWhatsApp);
